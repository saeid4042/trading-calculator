...
function App() {
  ...
  return (
    <ThemeProvider theme={theme}>
      <div className="App">
        <header>
          <motion.h1 {...getAnimationProps("FADE_FROM_BOTTOM")}>
            Trade Calculator
          </motion.h1>
          <motion.span
            {...getAnimationProps("FADE_FROM_TOP")}
            style={{ color: calculateModeColor() }}
          >
            <p>Position: </p>
            {calculateMode()}
          </motion.span>
        ...
        <motion.footer {...getAnimationProps("FADE", 0.5)}>
          <Button
            ...
            color="error"
            fullWidth
            onClick={() => _setFormData(initialData)}
          >
